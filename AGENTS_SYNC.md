...
5. [ ] **Verificar IA en producción:** `GET https://vitalcore-api.onrender.com/api/ai/diagnostics` debe mostrar `model_in_use` y `last_error: null`. Si no, revisar `GEMINI_API_KEY`.
6. [ ] **Salida a producción:** Completar los P0 de `AUDIT.md` (OAuth/OIDC, autorización por recurso y gobierno de datos de salud). Mantener `DEMO_MODE=true` hasta entonces.
