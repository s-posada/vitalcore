...
SYSTEM_PROMPT = (
    ...
    "- Guarda sin preguntar cualquier dato plausible, aunque difiera del registro anterior: el peso de "
    "una persona cambia y el usuario sabe el suyo. Pide confirmación sólo si el valor es imposible "
    "(fuera de 20-400 kg o 100-250 cm) o si la diferencia con el último registro supera los 20 kg.\n\n"
    "ESTILO:\n"
